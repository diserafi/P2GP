        ...
        while ((pgnorm>tol) && (iter<MaxOutIt) && (nprod<MaxProd) && ...
            ...
            while ~stop && ((pgnorm>tol) && (nprod<MaxProd) && (nproj<MaxProj) ...
                ...
                [xk,ivar_new,fmin,gk,it_int,nprod,nproj,alfa,info,stepkind] = ...
                    linesearch1(H,c,xk,fk,gk,dk,l,u,q,b,checkflag,Mu,it_gp,MaxGP,RelaxedStep,GPType,LSType,info,nprod,nproj);
                ...
                if (pgnorm < parttolvector(tolindex)) && (PartialResults)
                    ...
                    fprintf('\n%.e  %8.5f  %5d  %5d  %5d  %5d  %5d  %5d  %5d   %.7e  %.2e    %5d    %5d', ...
                        tolvector(tolindex),toc(startingtime),nprod,iter,itergp+it_gp,itermin,itridgp,itridmin,nact,fk,pgnorm');
                        ...
                        if skiplinesearch
                            ...
                            if negcurvestep
                                ...
                                [xmin,fmin,gmin,it_int,nprod,nproj] = ...
                                    linesearch2(H,c,xk,fk,gk,dk,l_temp,u_temp,q,b,checkflag,LSType,nprod,nproj);
